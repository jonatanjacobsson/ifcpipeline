...
VersionId pinning). `05-guid-index.sql` still creates `tester_results` and
`clash_pairs` (written by ifctester / ifcclash). Per-entity GUID indexing
lives in CDE, not this stack.
...
# --------------------------------------------------------------------------- #
# Tester / clash writers (ifctester-worker / ifcclash-worker)
# --------------------------------------------------------------------------- #
