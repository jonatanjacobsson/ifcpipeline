...
class Patcher:
    ...
    Example:
        ...
        # Suspended ceilings only, custom dimensions
    ...
    def _perimeter_offset_point(self, normal: Tuple[float, float, float]
        ...
        if point is None:
            point = self.file.createIfcCartesianPoint(pt)
    ...
    def _create_beam_at_segment(self, covering_element: ifcopenshell.entity_instance,
        ...
        if is_perimeter:
            ...
            if normal is not None:
                ...
                if direction[1] * normal[0] - direction[0] * normal[1] < 0:
                    start_point = segment["end_point"]
                    direction = (-direction[0], -direction[1], -direction[2])
                offset_pt = self._perimeter_offset_point((normal[0], normal[1], 0.0))
