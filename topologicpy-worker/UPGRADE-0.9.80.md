...
| KG TTL on A1, `include_bot=False` (golden 65,745) | equivalent, no mapped types | byte-identical to fix/topologicpy-guards | 92,596 triples, 0 `rdf:type bot:`/`brick:`/`prov:`; same golden coverage as above; `include_bot` toggles the same 490 triples in both versions |
